...
// $key = "bf84b03e04fca268e50fc7698e8d673e";
...
if (!empty($token)) {
            ...
            if ($db_tbl) {
                switch ($db_tbl) {
                    ...
                    case 'presensikelas':
                        ...
                        break;
                    case 'presensiEvent':
                        $query = "SELECT `nis`, `ruang`, `mulai`, `selesai`, `jam`, `tanggal`, `timestamp`, `keterangan` FROM $db_tbl";
                        $query = fullakses($akses, $redemcode, $db_tbl, $query);
                        $allowed = true;
                        break;
                    case 'jadwalkbm':
                ...
                http_response_code(404);
                echo json_encode(array("message" => "Permintaan tidak lengkap"));
            }
        }
    } else {
        http_response_code(404);
    ...
    http_response_code(404);
    echo json_encode(array("message" => "Permintaan tidak diterima"));
}
