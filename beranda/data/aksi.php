...
if (@$_POST['upload']) {
    ...
    $array_database = array(
        ...
        // datasiswa
        "nokartu, nis, nama, nick, kelas, foto, kelompok, t_waktu_telat, poin, created_at, updated_at, keterangan, tglawal, tglakhir, fotodoc, kode, tingkat, jur, saldo, total_transaksi, total_belanja, kontak, email, password, login",
        // jadwalgurujur
