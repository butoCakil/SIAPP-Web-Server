                    ...
                    <div class="card elevation-3">
                        <div class="card-header border-0 bg-gradient-dark">
                            <h3 class="card-title">
                                ...
                                Kehadiran Siswa <?= $ket_akses_login; ?>
                            </h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap">
                                <div class="col-6 text-center">
                                    <input type="text" class="knob" value="27" data-skin="tron" data-thickness="0.2" data-width="90" data-height="90" data-angleArc="1000" data-fgColor="#3c8dbc" data-readonly="true">

                                    <div class="knob-label">Hadir</div>
                                </div>

                                <div class="col-6 text-center">
                                    <input type="text" class="knob" value="5" data-skin="tron" data-thickness="0.2" data-angleOffset="0" data-width="90" data-height="90" data-fgColor="#00c0ef">

                                    <div class="knob-label">Ijin</div>
                                </div>

                                <div class="col-6 text-center">
                                    <input type="text" class="knob" value="4" data-skin="tron" data-thickness="0.2" data-width="90" data-height="90" data-fgColor="#f56954" data-readonly="true">

                                    <div class="knob-label">Alpa</div>
                                </div>

                                <div class="col-6 text-center">
                                    <input type="text" class="knob" value="90" data-skin="tron" data-thickness="0.2" data-angleArc="250" data-angleOffset="-125" data-width="90" data-height="90" data-fgColor="#00a65a">
